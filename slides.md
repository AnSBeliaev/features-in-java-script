...
<div class="tc39-stage">
<strong>Стадии - это не очередь.</strong> Фича может зависнуть на годы, откатиться назад или уйти в архив.
</div>
...
- **Обсуждают с 2016 года, сейчас Stage 2.7.** Проект доходил до Stage 3, но его вернули назад: декораторы меняют классы на лету, ломают оптимизацию движков и тормозят браузеры.
...
* **Официально вошел в стандарт.** Stage 4, войдёт в ES2027. Нативная поддержка уже есть в Firefox, Chrome и Node.js.
