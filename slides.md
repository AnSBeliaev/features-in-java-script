...
- **Откатились на стадию 2.7 из-за проблем со скоростью.** Проект доходил до Stage 3, но его вернули назад: декораторы меняют классы на лету, что ломает внутреннюю оптимизацию движков и сильно тормозит браузеры.
